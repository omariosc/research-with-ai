...
| --- | --- | --- |
| Source discovery | Linked source library and access review | Primary sources opened; automated link audit retained blocked pages for manual review; claims remain open to reader verification |
...
| Repository screenshots | Interface captures and a dated hash manifest | Captured from the actual site at desktop and mobile viewports; inspected for private data, crop, legibility, and release consistency |
...
status rather than relying on this statement indefinitely.
